...
import {Eye, EyeOff, Mail, Lock, Building, ArrowRight, Stethoscope, Shield, Mic} from 'lucide-react';
...
const Login = () => {
    ...
    const [formData, setFormData] = useState({
        email: '', password: '', tenantCode: '', rememberMe: false
    });
    ...
    return (<MainLayout>
        <div
            ...
            {/* Ondas de Sonido Médicas - Versión Mejorada */}
            <div className="fixed inset-0 overflow-hidden">
                {/* Onda principal - azul médico */}
                <motion.div
                ...
                <motion.div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                    animate={{
                        scale: [1, 2.6, 1], opacity: [0.2, 0, 0.2],
                    }}
                    transition={{
                        duration: 5, repeat: Infinity, ease: "easeOut", delay: 1,
                    }}
                >
                    <div className="w-64 h-64 border-4 border-blue-300/30 rounded-full"></div>
                </motion.div>

                {/* Partículas de voz flotantes */}
                {[...Array(6)].map((_, i) => (<motion.div
                    ...
                    animate={{
                        y: [0, -25, 0], opacity: [0.3, 0.8, 0.3], scale: [1, 1.3, 1],
                    }}
                    transition={{
                        duration: 2 + Math.random() * 2, repeat: Infinity, delay: Math.random() * 2,
                    }}
                />))}
            </div>
                                ...
                                <div
                                    ...
                                    <div className="flex items-end space-x-1">
                                        {[2, 4, 3, 2].map((height, index) => (<motion.div
                                            ...
                                            transition={{
                                                duration: 1.5, repeat: Infinity, delay: index * 0.2, ease: "easeInOut",
                                            }}
                                        />))}
                                    </div>
                                </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-6">
                        ...
                        <motion.button
                            ...
                            whileHover={!isLoading ? {
                                scale: 1.02, boxShadow: "0 10px 30px -10px rgba(37, 99, 235, 0.4)"
                            } : {}}
                            whileTap={{scale: 0.98}}
